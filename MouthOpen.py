...
mouthTracker = MouthOpenTrackingModule()

def is_mouth_open(face_landmarks):
    top_lip = face_landmarks['top_lip']
    bottom_lip = face_landmarks['bottom_lip']

    top_lip_height = mouthTracker.get_lip_height(top_lip)
    bottom_lip_height = mouthTracker.get_lip_height(bottom_lip)
    mouth_height = mouthTracker.get_mouth_height(top_lip, bottom_lip)
